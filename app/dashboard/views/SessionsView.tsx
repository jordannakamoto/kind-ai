...
export default function UserSessionHistory({ sidebarCollapsed = false }: { sidebarCollapsed?: boolean }) {
  ...
  return (
    <div className="bg-white min-h-screen py-4 md:py-8 sm:py-12 w-full">
      ...
      <div className={`hidden max-w-2xl ${sidebarCollapsed ? 'mx-auto' : 'ml-8 lg:ml-16'} px-4 sm:px-6 lg:px-8 mb-10`}> {/* Search Bar */}
      ...
      {showInitialLoading ? ( /* Loading Spinner */
        ...
        <div className={`text-center py-6 md:py-10 px-4 max-w-md ${sidebarCollapsed ? 'mx-auto' : 'ml-8 lg:ml-16'}`}>
        ...
        <div className={`max-w-2xl ${sidebarCollapsed ? 'mx-auto' : 'ml-8 lg:ml-16'} px-4 md:px-6 lg:px-8`}>
